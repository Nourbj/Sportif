    ...
    return (
      <div className="container profile-page">
        <div className="profile-card profile-empty">
          ...
          <p className="profile-text">يلزم تسجيل الدخول لعرض الملف الشخصي.</p>
          <Link to="/login" className="btn-red">تسجيل الدخول</Link>
        </div>
      </div>
    );
  }
    ...
    <div className="container profile-page">
      <div className="profile-hero">
        <div className="profile-header">
          ...
          <div>
            ...
            <div className="profile-role">{user.role === 'admin' ? 'مسؤول' : 'مستخدم'}</div>
          </div>
        </div>
      </div>
      ...
      <div className="profile-card">
        ...
        <form className="profile-form" onSubmit={onSubmit}>
          <h2 className="profile-section-title">تعديل البيانات</h2>
